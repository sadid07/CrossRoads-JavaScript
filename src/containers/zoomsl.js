...
(function ($, global) {
    ...
    $.extend(sergelandimagezoomer, {
        ...
        dsetting: { //default settings
            ...
            // подсказка (statusdiv)
            showstatus: false, // показывать при наведении на tmb help контейнер
            showstatustime: 0, // время показа help контейнера
            ...
            loopspeedanimate: 1.5 /*2.45342*/ , // перемещения области лупы и big контейнера в режиме лупы				
